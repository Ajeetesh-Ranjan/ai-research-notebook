  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg-base px-4">
      <div className="w-full max-w-sm rounded-xl border border-border-default bg-surface p-6 shadow-lg">
        ...
        <h1 className="mb-1 text-center text-xl font-semibold text-fg-primary">Sign in</h1>
        <p className="mb-4 text-center text-sm text-fg-muted">Enter your credentials to continue</p>
